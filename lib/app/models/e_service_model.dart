...
class EService extends Model {
  ...
  EService.fromJson(Map<String, dynamic> json) {
    ...
    durationHours = durationFromJson(json, 'durationHours');
    durationMin = durationFromJson(json, 'durationMin');
  ...
  Map<String, dynamic> toJson() {
    ...
    if (durationHours != null) data['durationHours'] = this.durationHours;
    if (durationMin != null) data['durationMin'] = this.durationMin;
