...
abstract class Model {
  ...
  DateTime dateOnlyFromJson(Map<String, dynamic> json, String attribute, {DateTime defaultValue}) {
    try {
      return json != null
          ? json[attribute] != null
          ? DateTime.parse(json[attribute])
          : defaultValue
          : defaultValue;
    } catch (e) {
      throw Exception('Error while parsing ' + attribute + '[' + e.toString() + ']');
  ...
  String durationFromJson(Map<String, dynamic> json, String attribute, {String defaultValue = '00:00', String fromFormat = "hh:mm a", String toFormat = "HH'h' mm'm'"}) {
    /*try {
