                    ...
                    children: [
                      ...
                      controller.enableResend.value
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              controller.enableResend.value = !controller.enableResend.value;
                              controller.addTimer();
                              controller.resendOTPCode();
                            },
                            child: Text("resend_otp_again".tr),
                          ),
                        ],
                      )
                          : Row(
                        ...
                        children: [
                          Text(
                            "wait_for_seconds".trArgs([controller.secondsRemaining.value.toString()]),
                          ),
                        ],
                      )
                    ],
