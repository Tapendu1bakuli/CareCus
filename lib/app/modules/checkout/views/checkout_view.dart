 ...
 * Last modified: 2022.02.14 at 12:57:35
              ...
              children: [
                Padding(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text("select_your_preferred_payment_mode".tr, style: Get.textTheme.caption),
                  ),
                ),
                ListView.separated(
        ...
        children: [
          ...
          Obx(() {
            return BlockButtonWidget(
                ...
                onPressed: Get.find<LaravelApiClient>().progress != null
                    ? null
                    : () async {
