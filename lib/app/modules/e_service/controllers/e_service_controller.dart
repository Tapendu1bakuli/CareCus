...
class EServiceController extends GetxController {
  ...
  Future refreshEService({bool showMessage = false}) async {
    ...
    await initBooking();
    if (showMessage) {
      Get.showSnackbar(Ui.SuccessSnackBar(message: eService.value.name + " " + "page_refreshed_successfully".tr));
    }
  }
  ...
  Future addToFavorite() async {
    try {
      ...
      Get.showSnackbar(Ui.SuccessSnackBar(message: this.eService.value.name + "added_to_favorite_list".tr));
    } catch (e) {
      Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
    }
  }
  ...
  Future removeFromFavorite() async {
    try {
      ...
      Get.showSnackbar(Ui.SuccessSnackBar(message: this.eService.value.name + "removed_from_favorite_list".tr));
    } catch (e) {
      Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
    }
  }
  ...
  void selectOption(OptionGroup optionGroup, Option option, EService eService) {
    if (eService?.enableBooking != null && eService.enableBooking) {
      ...
      Get.showSnackbar(Ui.notificationSnackBar(title: "alert".tr, message: "service_not_enabled_for_booking".tr));
    }
  }
