        ...
        return Scaffold(
          ...
          body: RefreshIndicator(
              onRefresh: () async {
                ...
                controller.refreshEService(showMessage: false);
      ...
      title: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: DurationChipWidget(durationHours: _eService.durationHours,durationMin: _eService.durationMin),
              ),
              Wrap(
                ...
                children: [
                  if (_eService.getOldPrice > 0)
                    Ui.getPrice(
                      ...
                      currency: _eService?.salon?.currency,
    ...
    if (_eService?.salon?.hasData ?? false) {
      return GestureDetector(
        ...
        child: EServiceTilWidget(
          title: Text("service_provider".tr, style: Get.textTheme.subtitle2),
          content: SalonItemWidget(salon: _eService.salon),
          actions: [
            Text("view_more".tr, style: Get.textTheme.subtitle1),
          ],
        ),
      );
    } else {
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Ui.getPrice(controller.booking.value.getSubtotal(),currency: controller.booking.value?.salon?.currency, style: Get.textTheme.headline6),
              ],
            )
          ],
        ),
