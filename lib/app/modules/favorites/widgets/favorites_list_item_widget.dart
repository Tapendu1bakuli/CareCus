              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: [
                      DurationChipWidget(durationHours: _favorite.eService.durationHours,durationMin: _favorite.eService.durationMin),
                      Column(
                        ...
                        children: [
                          if (_favorite.eService.getOldPrice > 0)
                            Ui.getPrice(
                              ...
                              currency: _favorite.eService?.salon?.currency,
