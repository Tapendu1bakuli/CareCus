        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text("contact_us".tr, style: Get.textTheme.subtitle2),
                Text("any_question".tr, style: Get.textTheme.caption),
              ],
            ),
          ),
          Wrap(
            ...
            children: [
              MaterialButton(
                onPressed: () {
                  launch("tel:${controller.salon.value.mobileNumber}");
                },
                height: 44,
                minWidth: 44,
              ...
              MaterialButton(
                onPressed: () {
                  launch("tel:${controller.salon.value.phoneNumber}");
                },
                height: 44,
                minWidth: 44,
                padding: EdgeInsets.zero,
