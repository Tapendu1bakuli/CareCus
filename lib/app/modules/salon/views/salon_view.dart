        ...
        return Scaffold(
          ...
          body: RefreshIndicator(
              onRefresh: () async {
                ...
                controller.refreshSalon(showMessage: false);
                ...
                child: Wrap(
                  ...
                  children: List.from(Ui.getStarsList(_salon.rate ?? 0))
                    ..addAll([
                      SizedBox(width: 5),
                      Text(
                        "Reviews_in_salon".trArgs([_salon.totalReviews.toString()]),
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              Ui.getPrice(_booking.getSubtotal(),currency: _booking?.salon?.currency, style: Get.textTheme.headline6),
            ],
          )
        ],
