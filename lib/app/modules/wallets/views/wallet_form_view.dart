  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Obx(() {
            return Text(
              controller.isCreateForm() ? "add_new_wallet".tr : controller.wallet.value.name,
              ...
              new IconButton(
                ...
                onPressed: () {
                  if (controller.wallet.value.balance > 0) {
                    Get.showSnackbar(Ui.ErrorSnackBar(message: "you_can_not_delete_non_empty_wallet".tr));
                  } else {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("fill_the_following_details_to_add_new_wallet".tr, style: Get.textTheme.caption).paddingSymmetric(horizontal: 22, vertical: 5),
                TextFieldWidget(
                  onSaved: (input) {
                  ...
                  validator: (input) => input.length < 1 ? "field_is_required".tr : null,
                  initialValue: controller.wallet.value.name,
                  hintText: "my_wallet".tr,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                Text("this_wallet_will_removed_from_your_account".tr, style: Get.textTheme.bodyText1),
              ],
            ),
          ),
          actions: <Widget>[
