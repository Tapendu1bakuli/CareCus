    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () async {
              ...
              await controller.refreshWallets(showMessage: false);
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("wallet_transactions".tr, style: Get.textTheme.headline5).paddingOnly(top: 25, bottom: 10, right: 22, left: 22),
                  Obx(() {
                    if (controller.loading.value) {
