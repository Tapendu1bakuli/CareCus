...
import '../modules/book_e_service/views/book_e_service_slot_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.BOOK_E_SERVICE_SLOT, page: () => BookEServiceSlotView(), binding: BookEServiceBinding(), middlewares: [AuthMiddleware()]),
