...
class SettingsService extends GetxService {
  ...
  Future<SettingsService> init() async {
    address.listen((Address _address) {
      _box.write('current_address_customer', _address.toJson());
    });
  ...
  Future getAddress() async {
    try {
      if (_box.hasData('current_address_customer') && !address.value.isUnknown()) {
        address.value = Address.fromJson(await _box.read('current_address_customer'));
