...
class Ui {
  ...
  static GetSnackBar ErrorSnackBar({String title = 'error', String message, SnackPosition snackPosition = SnackPosition.BOTTOM}) {
    ...
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6.merge(TextStyle(color: Get.theme.primaryColor))),
      messageText: Text(msg.tr, style: Get.textTheme.caption.merge(TextStyle(color: Get.theme.primaryColor))),
      snackPosition: snackPosition,
      margin: EdgeInsets.all(20),
  ...
  static Widget getPrice(double myPrice,
      {TextStyle style, String zeroPlaceholder = '-', String unit,Currency currency}) {
    NumberFormat numberFormat = NumberFormat.decimalPattern(Get.locale.languageCode);
    String finalPrice = numberFormat.format(myPrice);
    ...
    try {
      ...
      if(currency?.symbol?.isNotEmpty??false){
        return RichText(
          softWrap: false,
          ...
          text: _setting.setting.value.currencyRight != null &&
            ...
            children: <TextSpan>[
              TextSpan(
                  text: currency.decimalDigits == 0 ? finalPrice : myPrice.toStringAsFixed(currency.decimalDigits) ??
                      '',
              ...
              : TextSpan(
            text: currency.decimalDigits == 0 ? finalPrice : myPrice.toStringAsFixed(
        ...
        return RichText(
          ...
          text: _setting.setting.value.currencyRight != null &&
            ...
            children: <TextSpan>[
              TextSpan(
                  text:_setting.setting.value?.defaultCurrencyDecimalDigits == 0 ? finalPrice : myPrice.toStringAsFixed(_setting
              ...
              : TextSpan(
            text: _setting.setting.value?.defaultCurrencyDecimalDigits == 0 ? finalPrice : myPrice.toStringAsFixed(
